...
const uploadPhotosMW = (req, res, next) => {
  const uploader = generalFileUpload("workprogressPhotos").fields([
    { name: "photos", maxCount: 10 }, // Field name for file(s)
