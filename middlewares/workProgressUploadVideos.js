...
const uploadVideosMW = (req, res, next) => {
  const uploader = generalFileUpload("workprogressVideos").fields([
    { name: "videos", maxCount: 10 },   // Field name for file(s)
